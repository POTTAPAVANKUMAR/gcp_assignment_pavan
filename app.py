...
DATABASE ='/Users/pavankumarpotta/UC/cloudcomputing/GCP/example.db'
app = Flask(__name__)
...
def endchat():
    ...
    [Creator Details]<br>
    <label for="ufname"><strong>PAVAN KUMAR, POTTA, POTTAPR@mail.uc.edu</strong></label></br></br>
    """
